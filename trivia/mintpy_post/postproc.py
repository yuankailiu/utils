...
class tsRMS():
    ...
    # ----------------------------------------------------------------------------------
    def plot_network(self, SLC_path=None, return_values=False, plotTEC=False):
        from matplotlib import colors
    ...
    # ----------------------------------------------------------------------------------
    def plot_sceneNoise(self, average=False, shift=-1, SLC_path=None, ylog=False, return_values=False, plotTEC=False):
        ...
        if plotTEC is False:
            ...
            ax.bar(dates, rms, width=bar_width.days, color='coral')
            #line = ax.axhline(y=threshold              , linestyle='--', color='k'   , lw=3, label=label_thresh)
            #for i in range(len(highRMS_date)):
                #highbar = ax.bar(dates[highRMS_date[i]], rms[highRMS_date[i]], width=bar_width.days, color='lightgrey')
            if average is True:
