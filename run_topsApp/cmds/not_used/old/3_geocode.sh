...
## Steps that you may consider in this stage after geocoding:
# 'geocode'
# 'denseoffsets'
# 'filteroffsets'
# 'geocodeoffsets'
...
for ((i=0;i<${#use_steps[@]};i++)); do
    ...
    printf "##########################################################################################\n" >> ${logfile}
    (time topsApp.py ../example/topsApp_geocode.xml --dostep=${step}) 2>&1 | tee -a ${logfile}
    printf "\n\n\n" >> ${logfile}
done
