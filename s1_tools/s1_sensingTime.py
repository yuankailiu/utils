...
def check_verion(group):
    ...
    #print('++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
    print('slice                                                                    no   ver         IW1 start                  IW1 stop                  IW2 start                  IW2 stop                  IW3 start                  IW3 stop')
    print('+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
    info = ''
    remove_list = []
    for i in range(ngroup):
        ...
        for j in range(ngroup0):
            ...
            for k in range(3):
                xmlstr = zf.read(anna[k])
                root  = ET.fromstring(xmlstr)
                start = root.find('imageAnnotation/imageInformation/productFirstLineUtcTime').text
                stop  = root.find('imageAnnotation/imageInformation/productLastLineUtcTime').text
                sensingTime.append([start, stop])


            print_stuff += "{} {} {} {} {} {}".format(sensingTime[0][0], sensingTime[0][1], sensingTime[1][0], sensingTime[1][1], sensingTime[2][0], sensingTime[2][1])
            print(print_stuff)
...
def cmdLineParse():
    ...
    description = 'Updated version Jan 2021 by Ollie:\n \
        1. Report sentinel-1 product processing software info\n \
            (redirect to a file using > s1_sensingTime.txt manually)\n \
...
if __name__ == '__main__':
    ...
    sys.stdout=open("s1_sensingTime.txt","w+")
    ...
    print('Version check saved to ./s1_sensingTime.txt')
