...
if __name__ == '__main__':
    ...
    for x in pairs:
        print(f'{x}')
    #print('***************************************')
    print(f'total number of pairs created: {len(pairs)}')
    print(f'total number of acquisitions (dates): {ngroup-1}')
    ...
    if len(pairs2) != 0:
        ...
        for x in pairs2:
            print(f'{x}')
        print(f'total number of pairs not created: {len(pairs2)}')
    else:
